...
M.keys = {
	-- Pane related keys
	{ key = "s", mods = "ALT", action = wact.SplitHorizontal({ args = { "zsh" } }) },
	{ key = "v", mods = "ALT", action = wact.SplitVertical({ args = { "zsh" } }) },
	...
	-- Utilities
	{ key = "c", mods = "CTRL|SHIFT", action = wact.CopyTo("Clipboard") },
	{ key = "v", mods = "CTRL|SHIFT", action = wact.PasteFrom("Clipboard") },
